    ...
    <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-3">
                     <?php
                        $sql = "SELECT MAX(clicks) AS most FROM sashimi";
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            while ($row = mysqli_fetch_assoc($res)) {
                                $sql = "SELECT * FROM sashimi WHERE clicks=" . $row['most'];
                ...
                <div class="col-md-3">
                     <?php
                        $sql = "SELECT MAX(clicks) AS most FROM nigiri";
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            while ($row = mysqli_fetch_assoc($res)) {
                                $sql = "SELECT * FROM nigiri WHERE clicks=" . $row['most'];
                ...
                <div class="col-md-3">
                     <?php
                        $sql = "SELECT MAX(clicks) AS most FROM uramaki";
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            while ($row = mysqli_fetch_assoc($res)) {
                                $sql = "SELECT * FROM uramaki WHERE clicks=" . $row['most'];
